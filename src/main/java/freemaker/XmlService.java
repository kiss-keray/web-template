...
public class XmlService {
    //model.java存放的相对路径
    public static final String modelPath = ".\\src\\main\\java\\com\\nix\\model\\";
    //model所在的包名（实体model必须以xxxModel的类名）
    public static final String packageName = "com.nix.model";
    //生成mapping的路径
    public static final String mappingPath = ".\\src\\main\\java\\com\\nix\\mapping\\";
    //model实体后缀 后缀为Model的实体才会xml生成
